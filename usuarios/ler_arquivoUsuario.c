int ler_arquivoUsuario(Usuario usuarios[100])
{
    ...
    strcpy(usuarios[0].endereco, "Rua 0");
    strcpy(usuarios[0].dataDeNascimento, "02/01/1997");
    usuarios[0].id = 1;
    usuarios[0].acesso = 1;
    fflush(stdin);
    ...
    strcpy(usuarios[1].endereco, "Rua 0");
     strcpy(usuarios[1].dataDeNascimento, "02/01/1997");
    usuarios[1].acesso = 0;
    usuarios[1].id = 2;
